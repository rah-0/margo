...
func GetDBFunctions() string {
	...
	t += "	query := \"INSERT INTO \" + FQTN + \" (\" + strings.Join(GetQualifiedFields(fieldsToInsert), \", \") + \") VALUES (\" + strings.Join(GetValuesPlaceholders(fieldsToInsert), \", \") + \")\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	return stmt.Exec(x.GetFieldsValues(fieldsToInsert)...)\n"
	t += "}\n\n"
	...
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	return stmt.ExecContext(ctx, x.GetFieldsValues(fieldsToInsert)...)\n"
	t += "}\n\n"

	t += "func (x *Entity) DBDeleteWhereAll(fieldsToMatch []string) (sql.Result, error) {\n"
	t += "	query := \"DELETE FROM \" + FQTN + \" WHERE \" + strings.Join(GetQualifiedFields(fieldsToMatch), \" = ? AND \") + \" = ?\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	return stmt.Exec(x.GetFieldsValues(fieldsToMatch)...)\n"
	t += "}\n\n"
	...
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	return stmt.ExecContext(ctx, x.GetFieldsValues(fieldsToMatch)...)\n"
	t += "}\n\n"

	t += "func (x *Entity) DBDeleteWhereAny(fieldsToMatch []string) (sql.Result, error) {\n"
	t += "	query := \"DELETE FROM \" + FQTN + \" WHERE \" + strings.Join(GetQualifiedFields(fieldsToMatch), \" = ? OR \") + \" = ?\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	...
	t += "	query := \"UPDATE \" + FQTN + \" SET \" + strings.Join(GetQualifiedPlaceholders(fieldsToUpdate), \", \") + \" WHERE \" + strings.Join(GetQualifiedFields(fieldsToMatch), \" = ? AND \") + \" = ?\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	values := append(x.GetFieldsValues(fieldsToUpdate), x.GetFieldsValues(fieldsToMatch)...)\n"
	...
	t += "	query := \"UPDATE \" + FQTN + \" SET \" + strings.Join(GetQualifiedPlaceholders(fieldsToUpdate), \", \") + \" WHERE \" + strings.Join(GetQualifiedFields(fieldsToMatch), \" = ? OR \") + \" = ?\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	...
	t += "	query := \"SELECT \" + strings.Join(GetQualifiedFields(Fields), \", \") + \" FROM \" + FQTN\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	...
	t += "	query := \"SELECT \" + strings.Join(GetQualifiedFields(Fields), \", \") + \" FROM \" + FQTN + \" \" + subquery\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	...
	t += "func DBSubquerySelectAllWithFieldsContext(ctx context.Context, fields []string, subquery string, args ...any) ([]*Entity, error) {\n"
	t += "	query := \"SELECT \" + strings.Join(GetQualifiedFields(fields), \", \") + \" FROM \" + FQTN + \" \" + subquery\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	...
	t += "	query := \"SELECT \" + strings.Join(GetQualifiedFields(Fields), \", \") + \" FROM \" + FQTN +\n"
	t += "		\" WHERE \" + strings.Join(GetQualifiedFields(fieldsToMatch), \" = ? AND \") + \" = ?\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	rows, err := stmt.Query(x.GetFieldsValues(fieldsToMatch)...)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	defer rows.Close()\n"
	...
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	rows, err := stmt.QueryContext(ctx, x.GetFieldsValues(fieldsToMatch)...)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	t += "	defer rows.Close()\n"
	...
	t += "	query := \"SELECT \" + strings.Join(GetQualifiedFields(Fields), \", \") + \" FROM \" + FQTN +\n"
	t += "		\" WHERE \" + strings.Join(GetQualifiedFields(fieldsToMatch), \" = ? OR \") + \" = ?\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	...
	t += "	query := \"SELECT \" + strings.Join(GetQualifiedFields(Fields), \", \") +\n"
	t += "		\" FROM \" + FQTN + \" WHERE \" + strings.Join(GetQualifiedFields(fields), \" = ? AND \") + \" = ? LIMIT 1\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return false, err\n"
	t += "	}\n"
	t += "	rows, err := stmt.Query(x.GetFieldsValues(fields)...)\n"
	t += "	if err != nil {\n"
	t += "		return false, err\n"
	t += "	}\n"
	t += "	defer rows.Close()\n"
	...
	t += "		return false, err\n"
	t += "	}\n"
	t += "	rows, err := stmt.QueryContext(ctx, x.GetFieldsValues(fields)...)\n"
	t += "	if err != nil {\n"
	t += "		return false, err\n"
	t += "	}\n"
	t += "	defer rows.Close()\n"
	...
	t += "	query := \"SELECT COUNT(*) FROM \" + FQTN + \" WHERE \" + strings.Join(GetQualifiedFields(fields), \" = ? AND \") + \" = ?\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return 0, err\n"
	t += "	}\n"
	t += "	var count int\n"
	t += "	err = stmt.QueryRow(x.GetFieldsValues(fields)...).Scan(&count)\n"
	t += "	return count, err\n"
	t += "}\n\n"
	...
	t += "	}\n"
	t += "	var count int\n"
	t += "	err = stmt.QueryRowContext(ctx, x.GetFieldsValues(fields)...).Scan(&count)\n"
	t += "	return count, err\n"
	t += "}\n\n"

	t += "func (x *Entity) DBCountWhereAny(fields []string) (int, error) {\n"
	t += "	query := \"SELECT COUNT(*) FROM \" + FQTN + \" WHERE \" + strings.Join(GetQualifiedFields(fields), \" = ? OR \") + \" = ?\"\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return 0, err\n"
	t += "	}\n"
	...
	t += "	query := \"SELECT \" + strings.Join(GetQualifiedFields(Fields), \", \") + \" FROM \" + FQTN +\n"
	t += "		\" WHERE (\" + strings.Join(GetQualifiedFields(fieldsToMatch), \" = ? AND \") + \" = ?) \" + subquery\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
	...
	t += "	query := \"SELECT \" + strings.Join(GetQualifiedFields(Fields), \", \") + \" FROM \" + FQTN +\n"
	t += "		\" WHERE (\" + strings.Join(GetQualifiedFields(fieldsToMatch), \" = ? OR \") + \" = ?) \" + subquery\n"
	t += "	stmt, err := getPreparedStmt(query)\n"
	t += "	if err != nil {\n"
	t += "		return nil, err\n"
	t += "	}\n"
