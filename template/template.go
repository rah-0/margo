...
func GetGeneralFunctions(tfs []structs.TableField, nqs []structs.NamedQuery) string {
	...
	t += "func readRows(fields []string, rows *sql.Rows) (_ []*Entity, err error) {\n"
	t += "    defer func() { if cerr := rows.Close(); cerr != nil && err == nil { err = cerr } }()\n"
	...
	t += "    }\n"
	t += "    if rerr := rows.Err(); rerr != nil { return results, rerr }\n"
